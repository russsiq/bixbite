...
<head>
    <title>@yield('title', pageinfo()->makeTitles())</title>
    <meta charset="utf-8" />
    ...
    <link href="{{ mix('/css/app.css', 'themes/default') }}" rel="stylesheet" type="text/css" />
...
<body>
    ...
    <script src="{{ mix('js/manifest.js', 'themes/default') }}" charset="utf-8"></script>
    <script src="{{ mix('js/vendor.js', 'themes/default') }}" charset="utf-8"></script>
    <script src="{{ mix('js/app.js', 'themes/default') }}" charset="utf-8"></script>
    @g_recaptcha_script
    ...
    {{--
        Панель, оповещающая пользователя об использовании куков на сайте,
        содержит стили и скрипты, поэтому выносим за область влиянию Vue.
    --}}
    <x-consent-cookie />
</body>
