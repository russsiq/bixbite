 ...
 *
 * @source https://github.com/caouecs/Laravel-lang/blob/master/src/ru/validation.php
 */
return [
    ...
    'dimensions_large' => 'Изображение слишком большое для обработки: %sx%s.',
    ...
    /**
     * Собственные языковые строки для валидатора.
     */
    'custom' => [
        'attribute-name' => [
        ...
        'registration_rules' => [
            '*' => 'Необходимо принять правила регистрации.',

        ],

        'name' => [
            'unique' => 'Вы не можете использовать этот ник.',

        ],

        'email' => [
            'unique' => 'Вы не можете использовать этот email.',

        ],

        'content' => [
            'between' => 'Cообщение должно содержать от :min до :max символов.',
    ...
    /**
     * Собственные имена атрибутов.
     */
    'attributes' => [
        'g-recaptcha-response' => 'верификационный код',

        'name' => 'Имя',
        'username' => 'Имя полльзователя',
        'email' => 'E-Mail адрес',
        'first_name' => 'Имя',
        'last_name' => 'Фамилия',
        'password' => 'Пароль',
