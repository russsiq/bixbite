                    ...
                    <div class="card card-default">
                        ...
                        <div class="card-body">
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-5">
                                    <input type="number" v-model.number="form.avatar_max_width" min="20" class="form-control" />
                                </div>
                            </div>
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-5">
                                    <input type="number" v-model.number="form.avatar_max_height" min="20" class="form-control" />
                                </div>
                            </div>
