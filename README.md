...
Для успешного запуска тестов обязательным пунктом является очистка кэша конфигурации приложения. Нижеуказанные в этом разделе команды уже включают в себя предварительную очистку данного конфигурации. Повторное же кэширование кофигурации не предусмотрено этими командами.
