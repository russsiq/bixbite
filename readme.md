...
**Важно** При первом посещении админ. панели выполните настройки системы и модулей. В завершении выполните **Комплексную оптимизацию**.
...
**7** **Важно** При первом посещении админ. панели выполните настройки системы и модулей. В завершении выполните **Комплексную оптимизацию**.
