...
- [x] Группы пользователь и формирование привилегий для групп.
...
- [x] Похожие записи.
- [x] Архив записей.
- [x] Последние комментарии - *Обсуждения*.
- [x] Виджет тегов.
...
- [x] Задание приоритета для карт, частоты кеширования и обновлений.
