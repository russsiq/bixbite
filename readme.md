...
- [x] Индивидуальные шаблоны для категорий и записям из этих категорий. См. папку *custom_views*.
...
- [x] Для категорий.
- [x] Для записей и прикрепленных основных изображений к ним.
- [x] Задание частоты кеширования, обновлений.
