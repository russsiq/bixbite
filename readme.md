...
- [ ] Учет количества просмотров для сортировки по популярности.
- [ ] Автоудаление неиспользуемых тегов.
...
- [ ] Оповещение автора записи и других заинтересованных лиц об оставленном комментарии.
- [ ] Многостраничное отображение комментариев к записи. Тормозит сам вид ЧПУ.
- [ ] Премодерация.
...
- - [ ] критериия схожести: теги, релевантность;
- - [x] количество выводимых записей;
- - [x] способ и направление сортировки.
- [x] Виджет *Архив записей*.
- - [x] просто вывод ссылок по месячно по годам;
