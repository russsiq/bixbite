...
### Содержание
1. [Доступно-уже-или-запланировано](#Доступно-уже-или-запланировано)
1. [Требования](#Требования)
1. [Набор инструментов](#Необходимый-набор-инструментов)
1. [Установка](#Установка-bixbite)
1. [Подготовка](#Подготовка-файлов)
1. [Персонализация тем BixBite](#Персонализация-тем-bixbite-или-гремучая-смесь-зоопарка-технологий)
