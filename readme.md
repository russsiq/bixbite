...
#### Карты сайта
- [x] Создание карт для домашней страницы, категорий, записей и основных изображений, прикрепленных к ним, задание приоритета и частоты обновления, кэширование.
...
- [x] Вложенность, изменение позиций, отображение/скрытие из меню, прикрепление изображения, задание своих meta (description, keywords), отображение информации о категории на первой странице категории.
...
- [ ] Создать учет количества просмотров для сортировки по популярности, например, для виджета *Популярные теги*. Добавить автоудаление неиспользуемых тегов. По идее `null == $tag->taggable`.
