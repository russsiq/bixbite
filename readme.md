...
## Первичная персонализация тем BixBite или гремучая смесь "зоопарка технологий"

Выполнить `npm run watch` - это есть запуск наблюдения за изменениями файлов в папке `/resources/themes/{theme}/assets`. Отредактировать тему. По завершению редактирования в командной строке прервать наблюдение сочетанием клавиш *Ctrl+C*. Выполнить `npm run production` для сжатия и компиляции стилей и скриптов.
