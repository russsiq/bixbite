...
***Предостережение:*** выполняйте команды и установку программного обеспечения только поэтапно, не выполняйте всё разом! Не забывайте перезагрузить операционную систему перед следующим этапом.
